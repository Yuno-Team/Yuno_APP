...
class _TermsAgreementScreenState extends State<TermsAgreementScreen> {
  ...
  void _checkTermsScroll() {
    if (_termsScrollController.offset >= _termsScrollController.position.maxScrollExtent - 10) {
      setState(() {
  ...
  void _checkPrivacyScroll() {
    if (_privacyScrollController.offset >= _privacyScrollController.position.maxScrollExtent - 10) {
      setState(() {
  ...
  bool get _canProceed => _termsScrolledToEnd && _privacyScrolledToEnd;
            ...
            Container(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  onPressed: _canProceed ? _agreeAndContinue : null,
